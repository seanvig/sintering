...
The following code does essentially the equivalent operations as the fortran code, but takes advantages of R's powerful statistical packages to do it in fewer lines of code and avoids the necessity of the lengthy derivations described in Appendix II. For simplicity, I assume $n=1$ in the Johnson's equation.

**Load data and perform modeling**
